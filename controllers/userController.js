class UserController {
    ...
    async getUser(req, res) {
        try {
            ...
            let userData = {}; // Inicializa como objeto vazio
            ...
            if (user.tipo === 'cliente') {
                ...
                userData = clienteRows[0] || {}; // Fallback para objeto vazio
            }
                ...
                userData = restauranteRows[0] || {}; // Fallback para objeto vazio
            }
            ...
            res.status(500).json({
                ...
                error: error.message // Retorna a mensagem de erro específica
            });
        }
    }
}
