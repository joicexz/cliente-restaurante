class Restaurant {
    ...
    async create(idUsuario, idEndereco, restaurantData) {
        const [result] = await this.db.execute(
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
            [
                ...
                restaurantData.nome, restaurantData.cnpj, restaurantData.telefone,
                restaurantData.descricao, restaurantData.tempo_medio_entrega,
                restaurantData.taxa_entrega, restaurantData.horario_abertura,
                restaurantData.horario_fechamento
            ]
        );
